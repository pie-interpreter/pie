...
def assert_int(w_value):
    ...
    raise TypeAssertionError('int', w_value.get_type())
...
def assert_float(w_value):
    ...
    raise TypeAssertionError('float', w_value.get_type())
...
def assert_bool(w_value):
    ...
    raise TypeAssertionError('bool', w_value.get_type())
...
def assert_string(w_value):
    ...
    raise TypeAssertionError('string', w_value.get_type())
...
def assert_scalar(w_value):
    ...
    raise TypeAssertionError('int or float or bool or string', w_value.get_type())
